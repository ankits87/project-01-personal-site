...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${geistSans.variable} ${geistMono.variable} h-full antialiased`} suppressHydrationWarning>
      <body className="min-h-full flex flex-col bg-bg-default text-text-primary transition-colors">
        <ThemeProvider>
          <Navbar />
          <main className="flex-1">{children}</main>
          <footer className="text-center text-sm text-text-muted py-6 border-t border-border-default">
